class Solution:
    ...
    def minEatingSpeed(self, piles: List[int], h: int) -> int:
        ...
        while l <= r:
            ...
            if result > 0: # Finished bananas in time
                r = k - 1
            elif result < 0: # Did not finsish bananas in time
                l = k + 1
            else:
                return k
